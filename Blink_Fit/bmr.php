...
<a style="font-size:20px;color:#FFC107;text-decoration:blink;font-size:100px;" href="index.php"><img src="images/logo3.png" height="100px" width="100px"> <b style="color:white;">Blink </b> <b>Fit </b></a>
</div><br><br>
<div class="calculator_div">
	<form method="post" name="form1" onsubmit="return validateForm(this);">
		<p>
			<label>Your age:</label>
			<input type="text" placeholder="Enter your Age" size="15"  name="age" id="age" onkeyup="IsNumber(this.id)" value="<?php echo $_SESSION["calc_bmr_age"];?>" > 
		</p>
		<p>
			<label>Gender:</label>
        ...
        <p>
        	...
        	<select name="activity">    
    			<option value="0.2" <?if($_SESSION["calc_bmr_activity"]=="0.2") echo "selected"?> 1. No sport/exercise</option>
    			<option value="0.375" <?if($_SESSION["calc_bmr_activity"]=="0.375") echo "selected"?> 2. Light activity (sport 1-3 times per week)</option>
    			<option value="0.55" <?if($_SESSION["calc_bmr_activity"]=="0.55") echo "selected"?> 3. Moderate activity (sport 3-5 times per week)</option>
    			<option value="0.725" <?if($_SESSION["calc_bmr_activity"]=="0.725") echo "selected"?> 4. High activity (everyday exercise)</option>
    			<option value="0.9" <?if($_SESSION["calc_bmr_activity"]=="0.9") echo "selected"?> 5. Extreme activity (professional athlete)</option>	
        	</select>
        </p>
    	<?php endif;?>
	...
	<?php if(!empty($_POST['calculator_ok'])):?>
    	<div id="table">
	    	<div class="rowheader" style="background-color:orange;color:black;">
	...
	<?php endif;?>
    <p align="center">
    	<a href="index.php" style="color:white;text-decoration:blink;font-size:18px;">back to Bink Fit</a>
    </p>
</div>