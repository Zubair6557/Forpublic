...
?>
							...
							<li class="dropdown">
								...
								<li><<li><a href="bmr.php" target="_blank">Check BMI</a></li>
					...
					<span class="thumbnail">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<a href="supplements.php" class="pull-right btn btn-black">Back</a>
								<center><h2><?php echo $rows['sup_name']; ?></h2></center>
								<hr class="line">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-sm-6">
			      				<img src="admin/<?php echo $rows['sup_img']; ?>" alt="..." height="auto" width="100%">
			      			</div>
			      			<div class="col-md-6 col-sm-6">
				      			<div class="row">
				      				<div class="col-md-12 col-sm-12">
				      					<p style="color:black;font-size:15px;">
				      						<?php echo $rows['sup_dt']; ?>
				      					</p>
				      					<a class="btn btn-black pull-right" href="purchase_supplements.php?view=<?php echo $rows['supid']; ?>" ><img src="images/buy.png" height="30px" width="30px"> Buy Now</a>
				      				</div>
				      			</div>
				      		</div>
		      			</div>
