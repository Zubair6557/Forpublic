<?php
    ...
    if (isset($_REQUEST['search1'])) {
    	...
    	$sql    = "SELECT * FROM fit_videos WHERE video_type='free' and video_tag='".$sear1."'";
    	...
    	$sql    = "SELECT * FROM fit_videos WHERE video_type='free' ORDER BY video_id DESC";
    	$result = mysqli_query($conn,$sql);	
    }
...
?>
							...
							<?php } else { ?>
							<li class="active"><a href="video_free.php" class="effect-3">Videos</a>
							</li>
							<li><a href="about.php" class="effect-3">About</a></li>
							<li><a href="contact.php" class="effect-3">Contact</a></li>
							<?php } ?>
	...
	<div class="about-3" style="background-image:url('images/banner2.jpg');background-size:cover;">
		<div class="wthree_head_section">
				<h3 class="w3l_header">All Fr<span>ee Videos</span></h3>
			</div>
		<div class="container">
			<!-- <div class="d-flex"> -->
				<!-- <div class="about1"> 
