...
.btn-black1:hover {
	...
	<div class="about-3" style="background-image:url('images/banner2.jpg');background-size:cover;">
		<div class="wthree_head_section">
				<h3 class="w3l_header">All Equip<span>ments Details</span></h3>
			</div>
		<div class="container">
			<!-- <div class="d-flex"> -->
				<!-- <div class="about1"> 
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<a href="equipment_dt.php?view=<?php echo $rows['eqpid']; ?>" >
		    		<span class="thumbnail">
		      			<img src="admin/<?php echo $rows['eqp_img']; ?>" alt="..." height="250px" width="250px">
		      			<h4><?php echo $rows['eqp_name']; ?></h4>
		      			<hr class="line">
		      			<div class="row">
		      				...
		      				<div class="col-md-6 col-sm-6">
		      				 	<button class="btn btn-black1 right" > Show Details</button>
		      				</div>
