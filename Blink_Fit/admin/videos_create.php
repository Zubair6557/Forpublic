<?php
  ...
  <section id="main-content">
    <section class="wrapper">            
      ...
      <div class="row">
        <div class="col-lg-12">  
          <div style="color:white;background-color:red;font-size:20px;text-align:center;padding-top:15px;padding-bottom:12px;">Please Select the valid format Select Only MP4 format.</div>
  ...
  <?php     
      ...
      $ins_sql =  "INSERT INTO fit_videos(video_name, video_type, video_path, video_tag) VALUES ('".$name1."','".$type2."','".$move1."','".$tag2."')"; 
  ...
  <section id="main-content">
    <section class="wrapper">            
      ...
      <div class="row">
        <div class="col-lg-12">  
    <div style="color:white;background-color:green;font-size:20px;text-align:center;padding-top:15px;padding-bottom:12px;">Video created.</div>
                <script type="text/javascript">
                setTimeout(function () {            
                   window.location.href='videos_detail.php'; // the redirect goes here
                },2000);    
...
<section id="main-content">
    <section class="wrapper">            
	    ...
	    <div class="row">
    		<div class="col-lg-12">
    			<h3 class="page-header"><img src="img/video1.png" height="40px" width="40px"> Create Video</h3>
            </div>
	    </div>
        <div class="row">
       		<div class="col-lg-12 col-md-12">	
		      	<div class="panel panel-default">
			     	<div class="panel-heading">
				    	<h2><img src="img/video1.png" height="20px" width="20px"><strong> Create Video</strong></h2>
				    </div>
              ...
              enctype="multipart/form-data">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <input id="textinput" name="type1" type="radio" value="paid" checked=""> Paid
                    <input id="textinput" name="type1" type="radio" value="free" > Free
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <input id="name" name="video"  class="form-control input-lg" required="" type="file">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <input id="name" name="tag1" placeholder="Enter Video Tag" class="form-control input-lg" required="" type="text">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <a href="videos_detail.php" class="btn btn-danger">Cancel</a>
                    </div>
                  </div>
                </fieldset>
              </form>
