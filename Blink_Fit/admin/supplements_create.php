<?php
  ...
  if (isset($_REQUEST['save'])) {
    ...
    $ins_sql =  "INSERT INTO suppliments(sup_name,sup_img,sup_dt) VALUES ('".$name1."','".$move1."','".$dt1."')"; 
  ...
  <section id="main-content">
    <section class="wrapper">            
      ...
      <div class="row">
        <div class="col-lg-12">  
    <div style="color:white;background-color:green;font-size:20px;text-align:center;padding-top:15px;padding-bottom:12px;">Supplements created.</div>
...
<section id="main-content">
    <section class="wrapper">            
	    ...
	    <div class="row">
    		<div class="col-lg-12">
    			<h3 class="page-header"><img src="img/proteins1.png" height="40px" width="40px"> Create Supplements</h3>
            </div>
	    </div>
        <div class="row">
       		<div class="col-lg-12 col-md-12">	
		      	<div class="panel panel-default">
			     	<div class="panel-heading">
				    	<h2><img src="img/proteins1.png" height="20px" width="20px"><strong>Create Supplements</strong></h2>
				    </div>
              ...
              <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <input id="name" name="name" placeholder="Enter Supplements Name" class="form-control input-lg" required="" type="text">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <a href="supplements_detail.php" class="btn btn-danger">Cancel</a>
                    </div>
                  </div>
                </fieldset>
              </form>
