<?php
    ...
    {
        $sql1="DELETE FROM payment WHERE  payid='".$_REQUEST['del']."'" ;
        $resut1=mysqli_query($conn,$sql1);
    ?>
    <script type="text/javascript">window.location.href="payment_detail.php"</script>
    <?php
    }
?>
...
<!--sidebar start-->
        ...
        <section id="main-content">
            <section class="wrapper">            
        	    ...
        	    <div class="row">
            		<div class="col-lg-12">
            			<h3 class="page-header"><img src="img/credit-card.png" height="40px" width="40px"> Payment Details</h3>
                    </div>
        	    </div>
                <div class="row">
               		<div class="col-lg-12 col-md-12">	
        		      	<div class="panel panel-default">
        			     	<div class="panel-heading">
        				    	<h2><img src="img/credit-card.png" height="20px" width="20px"><strong> Payment Detaiils</strong></h2>
        				    </div>
        				    <div class="panel-body table-responsive">
                                <table class="table table-bordered  table-stripted" style="text-align:center;color:white;">
                                    ...
                                    <?php while ($rows=mysqli_fetch_array($result,MYSQLI_BOTH)){
                                        $sql1="SELECT * FROM member WHERE memid='".$rows['memid']."'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="payment_detail.php?del=<?php echo $rows['payid']; ?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </table>
