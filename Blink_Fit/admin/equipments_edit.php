<?php
  ...
  {
    $sql1="SELECT * FROM equipments WHERE eqpid='".$_REQUEST['eid']."' ";
  ...
  if (isset($_REQUEST['save'])) {
    ...
    if($image1==''){
      $up_sql =  "UPDATE equipments SET eqp_name='$name1',sup_dt='$dt1' WHERE eqpid='".$catid1."'"; 
    } else {
      $up_sql =  "UPDATE equipments SET eqp_name='$name1',eqp_img='$move1',eqp_dt='$dt1' WHERE eqpid='".$catid1."'"; 
    }
  ...
  ?>  
    ...
    <section class="wrapper">            
      ...
      <div class="row">
        <div class="col-lg-12">  
    <div style="color:white;background-color:royalblue;font-size:20px;text-align:center;padding-top:15px;padding-bottom:12px;">Equipments details Updated.</div>
...
<section id="main-content">
    <section class="wrapper">            
	    ...
	    <div class="row">
    		<div class="col-lg-12">
    			<h3 class="page-header"><img src="img/weightlifting1.png" height="40px" width="40px"> Update Equipment details</h3>
            </div>
	    </div>
        <div class="row">
       		<div class="col-lg-12 col-md-12">	
		      	<div class="panel panel-default">
			     	<div class="panel-heading">
				    	<h2><img src="img/weightlifting1.png" height="20px" width="20px"><strong> Update Equipment details</strong></h2>
				    </div>
				    <div class="panel-body">
              <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                <fieldset>
                  <input type="hidden" name="catid" value="<?php echo $rows['eqpid']; ?>">
                  <!-- Text input-->
                  <div class="form-group">
                    <label class="col-md-4 control-label" for="name">Name</label>  
                    <div class="col-md-5">
                    <input id="name" name="name" placeholder="Enter Equipment Name" class="form-control input-lg" required="" type="text" value="<?php echo $rows['eqp_name']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <input id="name" name="pic"  class="form-control input-lg" type="file">
                    </div>
                    <div class="col-md-3">
                    <img src="<?php echo $rows['eqp_img']; ?>" height="100px"  width="100px">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <textarea name="pdate" placeholder="Enter Full Details" class="form-control input-lg" required="" rows="5"><?php echo $rows['eqp_dt']; ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <a href="equipments_detail.php" class="btn btn-danger">Cancle</a>
                    </div>
                  </div>
                </fieldset>
              </form>
